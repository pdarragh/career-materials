...
\begin{cvlist}
  ...
  \cvitem{Initiated Viper project to self-direct research in programming
    languages.}
  \cvitem{Worked through half of \textit{Types and Programming Languages} to
    learn foundations of PL research.}
\end{cvlist}
...
\begin{cvlist}
  \cvinfo[$\lambda_{vc}$]{A lambda calculus with variadic functions and
    automatic currying.}
  \cvinfo[Swift PwZ]{A Swift implementation of \textit{Parsing with Zippers}.}
  \cvinfo[Viper]{A statically typed programming language implemented in Python.}
\end{cvlist}
