...
\begin{cvtable}
  ...
  \cventry{On one day of the week we covered content roughly lifted from
    ...
    each group had to choose a paper from a \cvurl[pre-approved
  ...
  \cventry{For CMSC 388X, I wrote an OCaml library for writing and parsing
    ...
    \texttt{\cvurl[s-exp-match?]{https://docs.racket-lang.org/plait/Predefined_Functions_and_Constants.html\#\%28def._\%28\%28lib._plait\%2Fmain..rkt\%29._s-exp-match~3f\%29\%29}}
